 ...
 */
package com.apexeducation.classcast;
...
public class PlayerActivity extends AppCompatActivity
    ...
    public static final String ACTION_VIEW = "com.classcast.action.VIEW";
    public static final String EXTENSION_EXTRA = "extension";

    public static final String ACTION_VIEW_LIST = "com.classcast.action.VIEW_LIST";
